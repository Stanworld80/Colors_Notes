...
class PaletteModelManagementPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Mes Modèles de Palettes'),
      ),
      body: userId == null
                ...
                child: ListTile(
                  leading: Wrap(
                    ...
                    children: model.colors
                      ...
                      width: 12,
                      height: 12,
                      color: _safeParseColor(c.hexValue),
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        tooltip: 'Supprimer',
                        onPressed: () => _showDeletePaletteModelConfirmDialog(
                            context, model, firestoreService),
                      ),
                    ],
                  ),
                ),
  ...
  void _showDeletePaletteModelConfirmDialog(
      BuildContext context, PaletteModel model, FirestoreService firestoreService) {
    showDialog(
        context: context,
