                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (commentChanged || timestampChanged) {
                      try {
                        await firestoreService.updateNoteDetails(note.id, newComment: commentChanged ? updatedComment : null, newEventTimestamp: timestampChanged ? updatedTimestamp : null);
                        Navigator.of(dialogContext).pop();
                        if (context.mounted) {
