...
void main() {
  group('Palette Model Tests', () {
    ...
    test('Constructeur devrait assigner les valeurs et générer un ID si non fourni', () {
      ...
      final palette = Palette(name: 'Ma Palette', colors: colors, userId: testUserId, isPredefined: false);
      ...
      final paletteWithId = Palette(id: 'custom-palette-id', name: 'Autre Palette', colors: []);
      expect(paletteWithId.id, 'custom-palette-id');
    });

    test('toMap devrait retourner une map correcte et inclure son propre ID', () {
      final colors = [createTestColor('c1', 'Rouge', '#FF0000'), createTestColor('c2', 'Bleu', '#0000FF')];
      final palette = Palette(
        id: 'paletteX-ID',
        // L'ID de la palette elle-même
        name: 'Palette X',
        colors: colors,
        userId: testUserId,
        isPredefined: true,
    ...
    test('copyWith devrait copier l\'instance avec/sans nouvelles valeurs', () {
      ...
      final paletteOrig = Palette(id: 'orig-p', name: 'Palette Originale', colors: [colorOrig1], userId: testUserId);
      ...
      final paletteCopiedModified = paletteOrig.copyWith(name: 'Palette Modifiée', colors: [colorNew], userId: 'newUser', isPredefined: true);
